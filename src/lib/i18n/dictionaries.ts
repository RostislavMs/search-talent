...
export const dictionaries = {
  en: {
    ...
    admin: {
      ...
      content: {
        ...
        discussionsDescription:
          "Standalone topics opened by members. Auto-promoted comment threads are moderated on their parent content.",
    ...
    metadata: {
      ...
      talents: {
        title: "IT Specialist Profiles & Portfolios",
        description:
          "Browse public profiles of developers, designers, and other IT specialists. Explore their portfolios, technologies, experience, and real completed projects.",
      },
      projects: {
        title: "Real IT Projects & Creator Portfolios",
        description:
          "Browse real IT projects with screenshots, technologies, descriptions, and author profiles. Discover new work and follow specialists.",
      },
      articles: {
        title: "Tech Articles, Guides & Case Studies",
        description:
          "Read technical articles, practical guides, case studies, and firsthand experience from SearchTalent authors on development, design, careers, and modern technology.",
      },
      news: {
      ...
      creatorProfile: {
        ...
        description:
          "View this creator's skills, experience, portfolio projects, and contacts. Discover and follow specialists on SearchTalent.",
      },
      projectDetail: {
      ...
      about: {
        title: "About SearchTalent — an IT Specialist Community",
        description:
          "SearchTalent is an open community of IT specialists where you can build a professional portfolio, publish projects, share knowledge, and unlock new opportunities.",
      },
      ratingGuide: {
    ...
    discussions: {
      ...
      metaTitle: "Discussion — {title}",
      metaDescription: "The full comment thread for “{title}”.",
      backToProject: "Back to the project",
      backToArticle: "Back to the article",
      backToPoll: "Back to the poll",
      empty: "This thread has no comments yet.",
      pageEyebrow: "Community",
      pageTitle: "Discussions",
      pageDescription:
        "Open topics, plus every comment thread across the site that grew into a conversation of its own.",
      pageMetaDescription:
        "Community topics and the busiest comment threads on projects, articles and polls.",
      startTopic: "Start a topic",
      emptyList: "No discussions yet. Be the first to start one.",
      emptyFiltered: "Nothing of this kind yet.",
      filterAll: "All",
      statTopics: "Topics",
      statThreads: "Threads",
      statComments: "Comments",
      myTitle: "My discussions",
      myDescription: "Topics you opened, drafts included.",
      myEmpty: "You have not opened a topic yet.",
      kindTopic: "Topic",
      kindProject: "Project",
      kindArticle: "Article",
      kindPoll: "Poll",
      ...
      newTopicDescription:
        "Ask a question or share an opinion, and start a conversation with the community.",
      editTopicTitle: "Edit topic",
      composerTitleLabel: "Title",
      composerTitlePlaceholder: "What do you want to discuss?",
      composerBodyLabel: "Topic",
      composerBodyPlaceholder: "Lay out your question or opinion...",
      composerPublish: "Publish topic",
      composerSaveDraft: "Save as draft",
      composerDraftSaved: "Draft saved.",
      composerSave: "Save changes",
      composerSaving: "Saving...",
      composerRequirements: "Add a title and a few sentences to publish.",
      composerPublishNote:
        "The topic appears in Discussions as soon as you publish.",
      composerPublished: "Topic published.",
      composerError: "Could not publish the topic. Please try again.",
      composerLeaveWarning: "The topic is not saved. Leave anyway?",
      composerLeaveConfirm: "Leave",
    },
    commentGif: {
      addGif: "Add GIF",
    ...
    providerIntegrations: {
      ...
      connectedMessage: "{provider} connected successfully.",
      connectError: "Could not finish the {provider} connect ({code}). Please try again.",
      disconnectedMessage: "{provider} disconnected.",
      disconnectError: "Could not disconnect. Please try again.",
      loadError: "Could not load the integration status.",
      importTitle: "Import from {provider}",
      notConnectedHint: "Connect {provider} to import this project from it.",
      connectedAs: "Connected as {login}",
      linkedTo: "Linked to {name}",
      pickResource: "Pick from {provider}",
      ...
      resourceError: "Could not load that item.",
      privateBadge: "private",
      importApplied: "{provider} data applied. You can still edit any field.",
      unlinkedMessage: "{provider} link removed. Save the project to apply.",
      syncNow: "Sync {provider}",
      syncing: "Syncing…",
      lastSynced: "Last synced",
      syncError: "Could not sync from the provider.",
      panelTitle: "Imported from {provider}",
      panelEmpty: "No data pulled yet — use “Sync” to fetch it.",
      stats: {
        stars: "Stars",
        forks: "Forks",
    ...
    githubIntegration: {
      title: "GitHub",
      description:
        "Import repositories as projects, with stats that stay current.",
    ...
    dashboardProfile: {
      ...
      avatarEditor: {
        ...
        dropActive: "Drop the photo to upload",
        dropOr: "or",
        browse: "browse files",
        formatsHint: "JPG, PNG or WebP",
        reposition: "Drag the photo to reposition",
        zoom: "Zoom",
        rotate: "Rotate",
    ...
    creatorProfile: {
      ...
      skillsShowAll: "Show all skills",
      skillsShowLess: "Show fewer skills",
    },
    forms: {
      ...
      videoGenreEdit: "Edit / montage",
      videoGenreAmv: "AMV / anime edit",
      videoGenreGamingMontage: "Gaming montage",
      videoGenreHighlights: "Highlights",
      videoGenreCommercial: "Commercial",
      videoGenreMusicVideo: "Music video",
      videoGenreLyricVideo: "Lyric video",
      ...
      videoGenreReaction: "Reaction",
      videoGenreReview: "Review",
      videoGenreTutorial: "Tutorial",
      videoGenreExplainer: "Explainer",
      videoGenrePodcast: "Podcast",
      videoGenreInterview: "Interview",
      videoGenreCorporate: "Corporate",
      videoGenreEvent: "Event",
      videoGenreWedding: "Wedding",
      ...
      hoursSpentLabel: "Time spent (hours)",
      hoursSpentPlaceholder: "e.g. 8",
      hoursSpentHint: "Roughly how long the project took, in hours.",
      fieldLockedUntilCompleted: "Unlocks when the status is “Completed”.",
      fieldLockedWhilePlanning: "Unlocks once the project has started.",
      technologies: "Technologies",
      ...
      stepBack: "Back",
      stepNext: "Next",
      projectActionsMenu: "Project actions",
      ...
      mediaLinkLabel: "Add a video link",
      mediaLinkHint:
        "Paste a link from YouTube, Vimeo, TikTok or Instagram — it embeds right in the project. Up to {limit} links.",
      mediaLinkPlaceholder:
        "youtube.com/… · vimeo.com/… · tiktok.com/… · instagram.com/…",
      mediaLinkAdd: "Add link",
      mediaLinkAddAnother: "Add another link",
      mediaLinkInvalid:
        "Unrecognized link. Paste a full YouTube, Vimeo, TikTok or Instagram video URL.",
      mediaLinkCount: "{current} of {limit} links",
      mediaLinkLimitReached:
        "The limit of {limit} video links is reached. Remove one to add another.",
      mediaCoverFrameButton: "Cover frame",
      mediaCoverFrameAdded: "Frame added as the project cover.",
      mediaSetCover: "Set as cover",
      videoLinksMovedHint:
        "Add video links (YouTube, Vimeo, TikTok, Instagram) in the final Media step — they embed straight into the gallery.",
      coverSectionTitle: "Project cover",
      coverSectionHint:
        "The image shown on cards and previews. Upload one, or capture a frame from an uploaded video below.",
      coverUploadButton: "Upload cover",
      coverReplaceButton: "Replace cover",
      coverEditButton: "Crop",
      coverRemoveButton: "Remove",
      coverAutoHint:
        "No cover yet — the first image (or a YouTube thumbnail) is used automatically.",
      ...
      coverEditorApply: "Apply",
      coverEditorCancel: "Cancel",
      coverEditorProcessing: "Processing…",
      videoCoverPickerTitle: "Choose a cover frame",
      videoCoverPickerHint:
        "Scrub to the moment you want, pause, then use it as the project cover.",
      videoCoverPickerUse: "Use this frame",
      videoCoverPickerWorking: "Capturing…",
      videoCoverPickerCancel: "Cancel",
      videoCoverPickerError: "Could not capture that frame. Try another moment.",
      videoCoverPickerBlack:
        "That frame looks black — scrub to a brighter moment and try again.",
      draftBadge: "Draft",
  ...
  uk: {
    ...
    admin: {
      ...
      content: {
        ...
        discussionsTitle: "Обговорення",
        discussionsDescription:
          "Окремі теми, створені учасниками. Автопромотовані треди коментарів модеруються на їхньому батьківському контенті.",
    ...
    metadata: {
      ...
      talents: {
        title: "Профілі IT-спеціалістів та портфоліо",
        description:
          "Переглядайте публічні профілі розробників, дизайнерів та інших IT-фахівців. Досліджуйте їхні портфоліо, технології, досвід і реальні виконані проєкти.",
      },
      projects: {
        title: "Реальні IT-проєкти та портфоліо авторів",
        description:
          "Переглядайте реальні IT-проєкти зі скриншотами, технологіями, описом і профілями авторів. Відкривайте нові роботи та підписуйтеся на спеціалістів.",
      },
      articles: {
        title: "Технічні статті, гайди та кейси спільноти",
        description:
          "Читайте технічні статті, практичні гайди, кейси та досвід авторів SearchTalent про розробку, дизайн, кар'єру й сучасні технології.",
      },
      news: {
      ...
      creatorProfile: {
        ...
        description:
          "Перегляньте навички, досвід, портфоліо-проєкти та контакти автора. Знаходьте та підписуйтесь на фахівців на SearchTalent.",
      },
      projectDetail: {
      ...
      about: {
        title: "Про SearchTalent — спільнота IT-фахівців",
        description:
          "SearchTalent — відкрита спільнота IT-фахівців, де можна створити професійне портфоліо, публікувати проєкти, ділитися знаннями та знаходити нові можливості.",
      },
      ratingGuide: {
    ...
    discussions: {
      sectionTitle: "Обговорення",
      openFull: "Перейти до обговорення",
      previewNote: "Показано {shown} із {total} коментарів.",
      metaTitle: "Обговорення — {title}",
      metaDescription: "Повний тред коментарів до «{title}».",
      backToProject: "Назад до проєкту",
      backToArticle: "Назад до статті",
      backToPoll: "Назад до опитування",
      empty: "У цьому треді ще немає коментарів.",
      pageEyebrow: "Спільнота",
      pageTitle: "Обговорення",
      pageDescription:
        "Відкриті теми, а також усі треди коментарів на сайті, які переросли в окрему розмову.",
      pageMetaDescription:
        "Теми спільноти та найактивніші треди коментарів до проєктів, статей і опитувань.",
      startTopic: "Створити тему",
      emptyList: "Обговорень поки немає. Створіть першу тему.",
      emptyFiltered: "Такого типу поки немає.",
      filterAll: "Усі",
      statTopics: "Теми",
      statThreads: "Треди",
      statComments: "Коментарі",
      myTitle: "Мої обговорення",
      myDescription: "Теми, які ви створили, разом із чернетками.",
      myEmpty: "Ви ще не створили жодної теми.",
      kindTopic: "Тема",
      kindProject: "Проєкт",
      kindArticle: "Стаття",
      kindPoll: "Опитування",
      draftBadge: "Чернетка",
      newTopicTitle: "Нова тема",
      newTopicDescription:
        "Поставте питання або поділіться думкою — і почніть розмову зі спільнотою.",
      editTopicTitle: "Редагувати тему",
      composerTitleLabel: "Назва",
      composerTitlePlaceholder: "Що хочете обговорити?",
      composerBodyLabel: "Тема",
      composerBodyPlaceholder: "Опишіть питання або думку...",
      composerPublish: "Опублікувати тему",
      composerSaveDraft: "Зберегти чернетку",
      composerDraftSaved: "Чернетку збережено.",
      composerSave: "Зберегти зміни",
      composerSaving: "Збереження...",
      composerRequirements: "Додайте назву й кілька речень тексту, щоб опублікувати.",
      composerPublishNote:
        "Тема з'явиться в розділі «Обговорення» одразу після публікації.",
      composerPublished: "Тему опубліковано.",
      composerError: "Не вдалося опублікувати тему. Спробуйте ще раз.",
      composerLeaveWarning: "Тема не збережена. Все одно вийти?",
      composerLeaveConfirm: "Вийти",
    },
    commentGif: {
      addGif: "Додати GIF",
      removeGif: "Прибрати GIF",
      searchPlaceholder: "Пошук GIF…",
      searching: "Пошук…",
      noResults: "GIF не знайдено",
      loadError: "Не вдалося завантажити GIF.",
      poweredBy: "Powered by GIPHY",
      categories: {
        trending: "У тренді",
        lol: "Смішне",
    ...
    notifications: {
      ...
      filters: {
        all: "Усі",
        mentions: "Згадки та коментарі",
        reactions: "Реакції",
        follows: "Підписники",
        content: "Новий контент",
        coAuthors: "Співавторство",
        moderation: "Модерація",
        badges: "Бейджі",
      },
      emptyFiltered: "У цій категорії поки немає сповіщень.",
    },
    providerIntegrations: {
      cardTitle: "{provider}",
      gitlabDescription:
      ...
      loading: "Перевіряю підключення…",
      connectedMessage: "{provider} успішно підключено.",
      connectError: "Не вдалося завершити підключення {provider} ({code}). Спробуйте ще раз.",
      disconnectedMessage: "{provider} відключено.",
      disconnectError: "Не вдалося відключити. Спробуйте ще раз.",
      loadError: "Не вдалося отримати стан інтеграції.",
      importTitle: "Імпорт із {provider}",
      notConnectedHint: "Підключіть {provider}, щоб імпортувати звідти проєкт.",
      connectedAs: "Підключено як {login}",
      linkedTo: "Пов’язано з {name}",
      pickResource: "Вибрати з {provider}",
      ...
      resourceError: "Не вдалося завантажити цей елемент.",
      privateBadge: "приватне",
      importApplied: "Дані з {provider} застосовано. Будь-яке поле можна відредагувати.",
      unlinkedMessage: "Звʼязок із {provider} прибрано. Збережіть проєкт, щоб застосувати.",
      syncNow: "Синхронізувати {provider}",
      syncing: "Синхронізація…",
      lastSynced: "Остання синхронізація",
      syncError: "Не вдалося синхронізувати з провайдером.",
      panelTitle: "Імпортовано з {provider}",
      panelEmpty: "Даних ще немає — натисніть «Синхронізувати».",
      stats: {
        stars: "Зірки",
        forks: "Форки",
        openIssues: "Відкриті задачі",
    ...
    githubIntegration: {
      title: "GitHub",
      description:
        "Імпортуйте репозиторії як проєкти — статистика оновлюється сама.",
      ...
      contributionPlaceholder:
        "Напр.: спроєктував схему БД, написав OAuth-flow, налаштував CI…",
    ...
    dashboardProfile: {
      ...
      avatarEditor: {
        ...
        title: "Оновіть фото профілю",
        dropTitle: "Перетягніть фото сюди",
        dropActive: "Відпустіть фото для завантаження",
        dropOr: "або",
        browse: "оберіть файл",
        formatsHint: "JPG, PNG або WebP",
        reposition: "Перетягуйте фото, щоб змістити його",
        zoom: "Масштаб",
        rotate: "Повернути",
        chooseAnother: "Обрати інше",
        cancel: "Скасувати",
        save: "Зберегти фото",
        saving: "Збереження...",
    ...
    creatorProfile: {
      ...
      skillsShowAll: "Показати всі навички",
      skillsShowLess: "Згорнути навички",
    },
    forms: {
      ...
      videoGenreEdit: "Едіт / монтаж",
      videoGenreAmv: "AMV / аніме-едіт",
      videoGenreGamingMontage: "Ігровий монтаж",
      videoGenreHighlights: "Хайлайти",
      videoGenreCommercial: "Реклама",
      videoGenreMusicVideo: "Музичне відео",
      videoGenreLyricVideo: "Лірик-відео",
      ...
      videoGenreReaction: "Реакція",
      videoGenreReview: "Огляд",
      videoGenreTutorial: "Туторіал",
      videoGenreExplainer: "Пояснювальне відео",
      videoGenrePodcast: "Подкаст",
      videoGenreInterview: "Інтерв'ю",
      videoGenreCorporate: "Корпоративне",
      videoGenreEvent: "Івент",
      videoGenreWedding: "Весілля",
      ...
      hoursSpentLabel: "Час на виконання (години)",
      hoursSpentPlaceholder: "напр. 8",
      hoursSpentHint: "Приблизно скільки часу зайняв проєкт, у годинах.",
      fieldLockedUntilCompleted: "Доступно зі статусом «Завершено».",
      fieldLockedWhilePlanning: "Доступно, коли проєкт стартує.",
      technologies: "Технології",
      ...
      stepBack: "Назад",
      stepNext: "Далі",
      projectActionsMenu: "Дії проєкту",
      ...
      mediaLinkLabel: "Додати посилання на відео",
      mediaLinkHint:
        "Вставте посилання з YouTube, Vimeo, TikTok чи Instagram — воно вбудується прямо в проєкт. Максимум {limit} посилання.",
      mediaLinkPlaceholder:
        "youtube.com/… · vimeo.com/… · tiktok.com/… · instagram.com/…",
      mediaLinkAdd: "Додати посилання",
      mediaLinkAddAnother: "Додати ще посилання",
      mediaLinkInvalid:
        "Нерозпізнане посилання. Вставте повний URL відео з YouTube, Vimeo, TikTok або Instagram.",
      mediaLinkCount: "{current} з {limit} посилань",
      mediaLinkLimitReached:
        "Досягнуто ліміту в {limit} відеопосилання. Приберіть одне, щоб додати нове.",
      mediaCoverFrameButton: "Кадр для обкладинки",
      mediaCoverFrameAdded: "Кадр додано як обкладинку проєкту.",
      mediaSetCover: "Зробити обкладинкою",
      videoLinksMovedHint:
        "Посилання на відео (YouTube, Vimeo, TikTok, Instagram) додавайте на фінальному кроці «Media» — вони вбудуються прямо в галерею.",
      coverSectionTitle: "Обкладинка проєкту",
      coverSectionHint:
        "Зображення на картках і прев'ю. Завантажте своє або захопіть кадр із завантаженого відео нижче.",
      coverUploadButton: "Завантажити обкладинку",
      coverReplaceButton: "Замінити обкладинку",
      coverEditButton: "Кадрувати",
      coverRemoveButton: "Прибрати",
      coverAutoHint:
        "Обкладинки ще немає — автоматично береться перше зображення (або прев'ю з YouTube).",
      ...
      coverEditorApply: "Застосувати",
      coverEditorCancel: "Скасувати",
      coverEditorProcessing: "Обробка…",
      videoCoverPickerTitle: "Виберіть кадр для обкладинки",
      videoCoverPickerHint:
        "Перемотайте до потрібного моменту, поставте на паузу й зробіть його обкладинкою проєкту.",
      videoCoverPickerUse: "Зробити обкладинкою",
      videoCoverPickerWorking: "Захоплюю…",
      videoCoverPickerCancel: "Скасувати",
      videoCoverPickerError: "Не вдалося захопити цей кадр. Спробуйте інший момент.",
      videoCoverPickerBlack:
        "Цей кадр чорний — перемотайте до світлішого моменту й спробуйте ще раз.",
      draftBadge: "Чернетка",
      ...
      employmentTypeFreelance: "Фріланс",
