...
export const dictionaries = {
  en: {
    ...
    forms: {
      ...
      mediaLinkHint:
        "Paste a link from YouTube, Vimeo, TikTok or Instagram — it embeds right in the project. Add as many as you like.",
  ...
  uk: {
    ...
    forms: {
      ...
      mediaLinkHint:
        "Вставте посилання з YouTube, Vimeo, TikTok чи Instagram — воно вбудується прямо в проєкт. Можна додати скільки завгодно.",
      mediaLinkPlaceholder:
        "youtube.com/… · vimeo.com/… · tiktok.com/… · instagram.com/…",
