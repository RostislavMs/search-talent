...
export default function DiscoveryPageSkeleton({
  ...
  return (
    <section>
      <section className="rounded-2xl border app-border bg-[color:var(--surface-muted)] p-5 sm:rounded-[2.25rem] sm:p-8 md:p-10">
        <div className="space-y-3">
          <Skeleton className="h-3 w-32 rounded-full" />
          <Skeleton className="h-8 w-3/4 rounded" />
          <Skeleton className="h-4 w-2/3 rounded" />
        </div>
        <div className="mt-6 rounded-2xl bg-[color:var(--surface)]/40 p-3 sm:rounded-[1.75rem] sm:p-4">
      ...
      <section className="mt-5 grid gap-8 sm:mt-8 xl:grid-cols-[18rem_minmax(0,1fr)]">
        <aside className="hidden space-y-4 xl:block">
          <div className="rounded-[2rem] app-card p-5 space-y-4">
          ...
          <div className="rounded-[2rem] app-card p-5 space-y-3">
